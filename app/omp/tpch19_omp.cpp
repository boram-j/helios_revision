...
// ==============================================================================
// Verification Logic (TPC-H 19 Specific)
// ==============================================================================
...
int main(int argc, char *argv[])
{
    if (argc != 6)
    {
        printf("./tpch19 < # runs > < debug mode > < # numEle_l for Lineitem> <# numEle_p for Part> <numThreads>\n"
            "[Debug Mode]\n0 - no debug\n"
...
#pragma omp single
{
    ...
    #pragma omp taskwait
        ...
        ctxt_revenue = ctxt_joined3;
        evaluator.add_inplace(ctxt_revenue, ctxt_joined1);
        time_tpch.pause();
        if(debug == 2) {
